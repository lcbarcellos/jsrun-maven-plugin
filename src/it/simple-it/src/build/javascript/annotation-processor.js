...
annotationProcessor(function process(round) {
    var
    ...
    log.warn("======================================================");
    log.warn(round.typeElements.toSource());
    log.warn("======================================================");
    log.warn(round.annotationTypes.toSource());
    log.warn("======================================================");
    it = round.annotationTypeSet.iterator();
    while (it.hasNext()) {
        typeElement = it.next();
        log.warn("--------------------------------------------");
        log.warn("Annotation Type is: " + typeElement.qualifiedName);
        processElements(round.roundEnvironment.getElementsAnnotatedWith(typeElement));
    }
});
